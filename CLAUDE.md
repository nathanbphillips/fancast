...
| **Room overhaul (Phase 11).** Desktop = stats LEFT 50% / merged chat+links stream RIGHT 50%. **Supersedes** the 2026-06-22 25/50/25 + expand/swap/companion layout and the "deeper stats inline only when expanded to 50%" entry (stats is permanently 50%, so deeper stats are always inline on desktop; mobile unchanged). | Founder decision 2026-06-24 | Final |
